package xyz.arkarhein.movieshelf.network;
...
import xyz.arkarhein.movieshelf.network.responces.GetMoviesResponces;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Log.d(MoviesApp.LOG_TAG, "respeonseString" + responseString);

                    Gson gson = new Gson();
                    GetMoviesResponces getMoviesResponse = gson.fromJson(responseString, GetMoviesResponces.class);
                    Log.d(MoviesApp.LOG_TAG, "getNewsResponse new size : " + getMoviesResponse.getPopularMovies().size());
